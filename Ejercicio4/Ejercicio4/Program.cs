...
namespace EjemploCola
{
    class Program
    {
        ...
        static void tarea(ref Cola co)
        {
            ...
            {
                pop(ref co, ref dato);
                if(dato=='a' || dato == 'A' || dato == 'e' || dato == 'E' || dato == 'i' || dato == 'I' || dato == 'o' || dato == 'O' || dato == 'u' || dato == 'U')
                {
                    cont++;
                }
                push(ref ct, dato);
            ...
            Console.WriteLine("La cantidad de vocales es: {0}", cont);
        }
        ...
        static void menu()
        {
            ...
            Console.WriteLine("4. CONTAR VOCALES VOCALES");
